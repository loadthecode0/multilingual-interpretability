...
model_choices = list(model_layer_counts.keys())
...
max_model_layers = max(model_layer_counts.values())

hookpoint_to_layer = {f"layers.{idx}.mlp": idx for idx in range(max_model_layers)}

mlp_to_index = {f"model.layers.{idx}.mlp": idx for idx in range(max_model_layers)}

mlp_acts_to_index = {
    f"model.layers.{idx}.mlp.act_fn": idx for idx in range(max_model_layers)
}
